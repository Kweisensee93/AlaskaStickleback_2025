...
#SBATCH --output=/storage/homefs/kw23y068/logfiles/svmeca_%j.out
#SBATCH --error=/storage/homefs/kw23y068/logfiles/svmeca_%j.err
...
apptainer exec \
  ...
  -B /storage/homefs/kw23y068/software/SV-MeCa_data/test/output:/workspace/SV-MeCa/results \
  -B /storage/homefs/kw23y068/software/SV-MeCa_data/test/tmp:/tmp \
  $CONTAINER \
...
rm -rf /storage/homefs/kw23y068/software/SV-MeCa_data/test/tmp/*
