#!/bin/bash
#SBATCH --job-name=consensusv_debug7
#SBATCH --output=../logfiles/consensusv_debug7_%j.out
#SBATCH --error=../logfiles/consensusv_debug7_%j.err
...
apptainer exec \
    ...
    --bind ${BASE_DIR}/software/ConsensuSV-pipeline/patched_consensusv_main.py:/tools/ConsensuSV-core/main.py \
